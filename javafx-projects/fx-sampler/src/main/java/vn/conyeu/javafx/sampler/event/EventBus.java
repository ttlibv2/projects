...
public interface EventBus {
     ...
     */
    static <T extends Event> void publishEvent(T event) {
        simple().publish(event);
    }

    static <E extends Event> void subscribeEvent(Class<? extends E> eventType, Consumer<E> subscriber) {
        simple().subscribe(eventType, subscriber);
    }

    static DefaultEventBus simple() {
