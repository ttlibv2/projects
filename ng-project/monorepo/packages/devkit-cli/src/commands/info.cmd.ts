...
import { CommandModule, CommandScope, Options, OtherOptions } from './abstract.cmd';
...
export default class InfoCmd extends CommandModule<InfoArg> {
    ...
    async run(options: Options<InfoArg> & OtherOptions): Promise<any> {
    ...
    private async displayCollection(options: Options<InfoArg> & OtherOptions) {
