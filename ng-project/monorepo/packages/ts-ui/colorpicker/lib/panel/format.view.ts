...
import { InputGroup} from "ts-ui/inputgroup";
...
@Component({
    ...
    imports: [ReactiveFormsModule, CommonModule, ClipboardModule, FormsModule, DropdownModule, InputNumberModule, InputGroup, ButtonModule],
    template: `
