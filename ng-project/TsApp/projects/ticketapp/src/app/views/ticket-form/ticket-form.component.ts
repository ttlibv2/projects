...
const { notNull, notEmpty, isEmpty, isNull, notBlank, isTrue } = Objects;
...
export class TicketFormComponent implements OnInit {
  ...
  searchUser(option?: {autoSelect: boolean, timeDelay?: number}) {
