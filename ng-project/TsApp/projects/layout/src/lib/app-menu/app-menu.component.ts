...
@Component({
  selector: "ts-app-menu",
  templateUrl: "./app-menu.component.html",
})
export class AppMenuComponent {
  model: MenuItem[] = this.layoutService.config().listMenu ?? demoMenu;

  modelTrackBy: TrackByFunction<MenuItem> = (index, item) =>
    `model-${index}-${item.label}`;
