...
import { normalizeToKebabOrSnakeCase } from '../utilities/formatting';
...
export abstract class AbstractPackageManager {
  ...
  async addDevelopment(dependencies: string[], tag: string) {
  ...
  public async getProduction(): Promise<ProjectDependency[]> {
    ...
    const packageJsonDependencies: ProjectDependency = packageJsonContent.dependencies;
  ...
  public async getDevelopment(): Promise<ProjectDependency[]> {
    const packageJsonContent = await this.readPackageJson();
    const packageJsonDevDependencies: ProjectDependency = packageJsonContent.devDependencies;
    const dependencies:ProjectDependency[] = [];
