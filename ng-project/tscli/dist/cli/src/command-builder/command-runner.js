...
function runCommand(args, logger) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const _c = yargsParser(args, {
            boolean: ['help', 'json-help', 'get-yargs-completions'],
            alias: { 'collection': 'c' },
        }), { $0, _, help = false, jsonHelp = false, getYargsCompletions = false } = _c, rest = __rest(_c, ["$0", "_", "help", "jsonHelp", "getYargsCompletions"]);
        ...
        try {
            [workspace, globalConfiguration] = yield Promise.all([
