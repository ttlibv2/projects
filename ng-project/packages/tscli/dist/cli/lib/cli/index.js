...
const command_module_1 = require("../../src/command/core/command-module");
const command_runner_1 = require("../../src/command/core/command-runner");
...
async function default_1(options) {
    ...
    const loggerFinished = logger.forEach((entry) => {
        if (!environment_1.ngDebug && entry.level === 'debug') {
            return;
        }
