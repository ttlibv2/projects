...
class GenerateCommandModule extends schematics_cmd_1.SchematicsCommandModule {
    command = 'generate|gen <schematic>';
    aliases = command_list_1.RootCommands['generate'].aliases;
    ...
    async builder(argv) {
        ...
        return localYargs.demandCommand(1, add_cmd_to_args_1.demandCommandFailureMessage);
    }
    async run(options) {
        ...
        if (!collectionName || !schematicName) {
            throw new abstract_cmd_1.CommandModuleError('A collection and schematic is required during execution.');
        }
...
//# sourceMappingURL=generate.cmd.js.map