...
const architectbase_cmd_1 = require("./architectbase.cmd");
const abstract_cmd_1 = require("./abstract.cmd");
let ArchitectCommandModule = (() => {
    let _classSuper = architectbase_cmd_1.ArchitectBaseCommandModule;
        ...
        getProjectNamesByTarget(target) {
            ...
            if (this.multiTarget) {
                ...
                if (!getYargsCompletions && !help) {
                    ...
                    throw new abstract_cmd_1.CommandModuleError('Cannot determine project for command.\n' +
...
//# sourceMappingURL=architect.cmd.js.map