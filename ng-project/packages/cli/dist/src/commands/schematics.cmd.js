...
const engine_host_1 = require("./helper/engine-host");
const schematic_workflow_1 = require("./helper/schematic-workflow");
const collection_1 = require("../collection/collection");
exports.DEFAULT_SCHEMATICS_COLLECTION = collection_1.Collection.NgDevSC;
class SchematicsCommandModule extends abstract_cmd_1.CommandModule {
    ...
    getOrCreateWorkflowForBuilder(collectionName) {
        return new tools_1.NodeWorkflow(this.context.root, {
            ...
            engineHostCreator: (options) => new engine_host_1.EngineHost(options.resolvePaths),
        });
    }
    //@memoize
        ...
        if (options.interactive !== false && (0, tty_1.isTTY)()) {
            workflow.registry.usePromptProvider(async (definitions) => {
                ...
                for (const definition of definitions) {
                    ...
                    prompts ??= await Promise.resolve().then(() => require('@inquirer/prompts'));
...
//# sourceMappingURL=schematics.cmd.js.map