...
exports.MESSAGES = {
    ...
    PACKAGE_MANAGER_INSTALLATION_SUCCEED: (name) => name !== '.' ? `${emojis_1.EMOJIS.ROCKET}  Successfully created project ${(0, ansis_1.green)(name)}` : `${emojis_1.EMOJIS.ROCKET}  Successfully created a new project`,
    ...
    INFORMATION_PACKAGE_WARNING_FAILED: (nestDependencies) => `${emojis_1.EMOJIS.SMIRK}  failed to compare dependencies versions, please check that following packages are in the same minor version : \n ${nestDependencies.join('\n')}`,
