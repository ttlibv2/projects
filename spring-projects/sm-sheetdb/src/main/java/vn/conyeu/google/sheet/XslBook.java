...
public final class XslBook {
    ...
    public XslSheet addSheet(ConsumerReturn<SheetPropertiesBuilder> consumer) {
        SheetProperties sp = service.addSheet(getId(), consumer);
    ...
    public void deleteSheet(int sheetId) {
        service.deleteSheet(getId(), sheetId);
    ...
    public XslBook save() {
        if(propertiesBuilder != null) {
            this.properties = service.updateXsl(getId(), propertiesBuilder);
    ...
    private XslBook async(String fields) {
            Spreadsheet ss = service.openXsl(getId(), fields);
