...
import static vn.conyeu.cookie.Helper.toLowerCaseAsciiString;
...
public final class DateFormat {
    ...
    private boolean tryParseMonth(CharSequence txt, int tokenStart, int tokenEnd) {
        ...
        char monthChar1 = toLowerCaseAsciiString(txt.charAt(tokenStart));
        char monthChar2 = toLowerCaseAsciiString(txt.charAt(tokenStart + 1));
        char monthChar3 = toLowerCaseAsciiString(txt.charAt(tokenStart + 2));
