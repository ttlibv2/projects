...
import * as Constants from './device.common';
...
export class DeviceDetectorService {
  ...
  setDeviceInfo(ua = this.userAgent): void {
    ...
    mappings.forEach((mapping: any) => {
        self[mapping.prop] = Object.keys(Constants[mapping.const]).reduce((obj: any, item: any) => {
    ...
    mappings.forEach(mapping => {
      self[mapping.prop] = Object.keys(Constants[mapping.const])
        .map(key => {
        ...
        .reduce((previousValue, currentValue) => {
          if (mapping.prop === 'device' && previousValue === Constants[mapping.const].ANDROID) {
            ...
            return previousValue === Constants[mapping.const].UNKNOWN && self[mapping.prop][currentValue]
              ? currentValue
              : previousValue;
          }
