...
public class OdMessage extends OdTicketCore<ClsMessage> {
    private final OdFile odFile;

    public OdMessage(ClsApiConfig apiConfig, OdFile odFile) {
        super(apiConfig);
    ...
    public ClsMessage create(ClsMessage clsNote) {
        ...
        ObjectMap mapData = sendPost("/mail/message/post", argBody).getMap("result");
